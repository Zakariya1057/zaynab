...
export function DemoCard(props: CardProps) {
    return (
        <Card elevate size="$4" bordered {...props} br={'$5'} overflow={'hidden'}>
            <XStack>
                <Image
                    resizeMode="cover"
                    alignSelf="center"
            ...
            <Card.Footer padded pt={0} f={1} >
                ...
                <PlayCircle size={'$3'} strokeWidth={1}/>
            </Card.Footer>
...
export const Podcast = ({ title, speaker, image, episode }) => (
    <TouchableOpacity onPress={() => episode ? router.push('/episode') : router.push('/podcast') }>
        <XStack
            gap="$3"
            alignItems="center"
            borderRadius="$3"
        >
            ...
            <YStack f={1} justifyContent="center" space="$2">
                ...
                <Paragraph color="$textSecondary">{speaker}</Paragraph>
            </YStack>
            <YStack justifyContent="center" padding="$2">
                <PlayCircle size="$4" strokeWidth={1} color="$primary" />
            </YStack>
        </XStack>
    </TouchableOpacity>
