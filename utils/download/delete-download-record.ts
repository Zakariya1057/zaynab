...
export const deleteDownloadRecord = async (download: DownloadModel, displayToast: boolean = true) => {
    try {
        ...
        displayToast && showToast('success', 'Download Deleted', `All data for episode has been successfully removed.`);
    } catch (error) {
